...
dloader = DataLoader(dset, batch_size=16, num_workers=2)
...
pred_df = run_model(model,dloader, ['mass'], seg=True, save_dir="/fast_data_e2e_1/cxr/qxr_ln_data/checking/")
output_filename = f"/fast_data_e2e_1/cxr/qxr_ln_data/checking/mass/mass_scores2.csv"
